...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for client_documents" ON storage.objects FOR SELECT USING (bucket_id = 'client_documents');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for client_documents" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'client_documents');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for client_documents" ON storage.objects FOR UPDATE USING (bucket_id = 'client_documents');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for client_documents" ON storage.objects FOR DELETE USING (bucket_id = 'client_documents');`
    ];
